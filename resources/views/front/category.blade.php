                        ...
                        <li>
                          <figure>
                            ...
                            <figcaption>
                              ...
                              <span class="aa-product-price">Rial {{$product_attr[$productArr->id][0]->price}}</span><span class="aa-product-price"><del>Rial {{$product_attr[$productArr->id][0]->mrp}}</del></span>
                            </figcaption>
                          </figure>                          
                        </li>  
                        @endforeach    
