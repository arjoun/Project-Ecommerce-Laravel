...
<html lang="en">
    ...
    <link rel="stylesheet" href="{{asset('front_assets/webfonts/flaticon/flaticon.css')}}">
    <link rel="stylesheet" href="{{asset('front_assets/webfonts/icofont/icofont.min.css')}}">
            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-left">
                ...
                <div class="cellphone hidden-xs">
                  <p><span class="fa fa-phone"></span>0595808712</p>
                </div>
                <!-- / cellphone -->
              </div>
              <!-- / header top left -->
          ...
          <div class="col-md-12">
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                <!-- Text based logo -->
                <a href="{{url('/')}}">
                  <span class="icofont-prestashop"></span>
                  <p>Safe<strong>Decision</strong> <span>Test Shopping</span></p>
                </a>
                <!-- img based logo -->
              ...
              <div class="aa-cartbox">
                <a class="aa-cart-link" href="#" id="cartBox">
                  <span class="icofont-opencart"></span>
                ...
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    ...
                    <address>
                      ...
                      <p><span class="fa fa-phone"></span>0595808712</p>
                      <p><span class="fa fa-envelope"></span>arjounidhal@gmail.com</p>
                    </address>
      ...
      <div class="container">
        ...
        <div class="col-md-12">
          <div class="aa-footer-bottom-area">
            <p>Designed by <a href="">ARJOUN NIDHAL</a></p>
